    ...
    if (timer == (24 - attack_speed))
    {
        ...
        if (createbullets == true)
        {
            ...
            for (a = 0; a < density; a++)
            {
                ...
                with (scr_fire_bullet(px, py, 1407, (((360 / density) * a) + (random_aim * 7) + (180 / density)) - (5 * spin), 18 * speedmod, 2361))
                {
    ...
    if (timer == (28 - attack_speed))
    {
        if (createbullets == true)
        {
            for (a = 0; a < density; a++)
            {
                ...
                with (scr_fire_bullet(px, py, 1407, ((360 / density) * a) + (random_aim * 7), 18 * speedmod, 2361))
                {
                ...
                with (scr_fire_bullet(px, py, 1407, ((360 / density) * a) + (random_aim * 7) + 10, 16 * speedmod, 2361))
                {
