    ...
    if (attack_timer == 4)
    {
        ...
        if (starcount_p1 == 1 && intensity < 3.7)
        {
            if (intensity >= 2.7)
            {
                ...
                repeat (2)
                {
                    with (scr_fire_bullet(camerax() + fake_x + lengthdir_x(rand_dist, star_angle1 + _o), cameray() + fake_y + lengthdir_y(rand_dist, star_angle1 + _o), 31, 0, 0, 4134))
                    {
                        wall_destroy = false;
                        destroyonhit = false;
                        bottomfade = false;
            ...
            else
            {
                ...
                repeat (6)
                {
                    ...
                    with (scr_fire_bullet(camerax() + fake_x + lengthdir_x(rand_dist, rand_angle), cameray() + fake_y + lengthdir_y(rand_dist, rand_angle), 31, 0, 0, 4134))
                    {
                        wall_destroy = false;
                        destroyonhit = false;
                        bottomfade = false;
        ...
        if (star_angle1 != -1)
        {
            with (scr_fire_bullet(camerax() + fake_x + lengthdir_x(rand_dist, star_angle1), cameray() + fake_y + lengthdir_y(rand_dist, star_angle1), 31, 0, 0, 4134))
            {
                wall_destroy = false;
                destroyonhit = false;
                bottomfade = false;
        ...
        {
            with (scr_fire_bullet(camerax() + fake_x + lengthdir_x(rand_dist, star_angle2), cameray() + fake_y + lengthdir_y(rand_dist, star_angle2), 31, 0, 0, 4134))
            {
                wall_destroy = false;
                destroyonhit = false;
                bottomfade = false;
        ...
        {
            with (scr_fire_bullet(camerax() + fake_x + lengthdir_x(rand_dist, star_angle3), cameray() + fake_y + lengthdir_y(rand_dist, star_angle3), 31, 0, 0, 4134))
            {
                wall_destroy = false;
                destroyonhit = false;
                bottomfade = false;
        ...
        if (intensity < 2.7 && star_angle1 != -1)
        {
            ...
            with (scr_fire_bullet(camerax() + fake_x + lengthdir_x(rand_dist, star_angle1 + 45 + _rand), cameray() + fake_y + lengthdir_y(rand_dist, star_angle1 + 45 + _rand), 31, 0, 0, 4134))
            {
                wall_destroy = false;
                destroyonhit = false;
                bottomfade = false;
...
if (intensity == 4)
{
    ...
    if (roaring_timer < 169)
    {
        if (roaring_timer == 9)
        {
            ...
            for (a = 0; a < 8; a++)
            {
                with (scr_fire_bullet(camerax() + fake_x, cameray() + fake_y + 55, 31, a * 45, 8.5 + random(2), 4134))
                {
                    visible = false;
                    wall_destroy = false;
                    bottomfade = false;
        ...
        if (roaring_timer > 15 && (roaring_timer % 5) == 0)
        {
            ...
            if (star_angle1 != -1)
            {
                with (scr_fire_bullet(camerax() + fake_x, cameray() + fake_y + 55, 31, star_angle1, 6.5 + random(2), 4134))
                {
                    visible = false;
                    wall_destroy = false;
                    bottomfade = false;
            ...
            if (star_angle2 != -1)
            {
                with (scr_fire_bullet(camerax() + fake_x, cameray() + fake_y + 55, 31, star_angle2, 8.5 + random(2), 4134))
                {
                    visible = false;
                    wall_destroy = false;
                    bottomfade = false;
            ...
            if (star_angle3 != -1)
            {
                with (scr_fire_bullet(camerax() + fake_x, cameray() + fake_y + 55, 31, star_angle3, 8.5 + random(2), 4134))
                {
                    visible = false;
                    wall_destroy = false;
                    bottomfade = false;
