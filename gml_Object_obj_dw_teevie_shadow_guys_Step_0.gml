...
if (con == 2)
{
    ...
    if (timer == 1)
    {
        ...
        for (var i = 0; i < (array_length(sadshad) - 1); i++)
        {
            if (i_ex(sadshad[i]))
            {
                var newshad = scr_marker_ext(sadshad[i].x + xoff, sadshad[i].y + yoff, 4372, 2, 2, 0.25, undefined, undefined, 96539);
...
if (con == 3)
{
    ...
    for (var i = 0; i < 5; i++)
    {
        ...
        {
            with (scr_marker_ext(camerax() - 80, 242, 4372, 2, 2, 0.35, undefined, undefined, 96539))
            {
