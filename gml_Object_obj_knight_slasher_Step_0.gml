...
if (state == "slash")
{
    ...
    if ((image_index == 3 && !reverse) || (image_index == 3.75 && reverse))
    {
        ...
        var roarknight_slash = scr_fire_bullet(x + 40, ((y + (sprite_height * 0.5)) - 20) + 20, 1727, 0, 0, 3802);
        ...
        roarknight_slash = scr_fire_bullet(x + 40, y + (sprite_height * 0.5) + 20 + 20, 1727, 0, 0, 3802);
