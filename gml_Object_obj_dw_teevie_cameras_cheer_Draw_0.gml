...
if (room == room_dw_tv_curtain || room == room_mod_initial || room == room_dw_teevie_large_01 || room == room_dw_teevie_shuttahmaze)
    _type = 1;
...
if (_type == 1)
{
    ...
    if (room == room_mod_initial || room == room_dw_teevie_large_01)
