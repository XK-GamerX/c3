...
if (active == 1 && obj_board_camera.con == 0)
{
    ...
    if (con == 34 && !bw_ex())
    {
        ...
        if (timer == 5)
        {
            ...
            q2 = scr_board_marker(obj_board_inventory.x + 8 + 32, obj_board_inventory.y + 10 + 48, 4843);
        ...
        if (timer == 20)
        {
            ...
            q1 = scr_board_marker(obj_board_inventory.x + 8, obj_board_inventory.y + 10 + 48, 4843);
