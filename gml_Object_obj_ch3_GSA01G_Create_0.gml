...
textfade = 20;
tennafade = 8;
screenshot_overlay = scr_marker_ext(0, 0, 4888);
...
prize1object = scr_marker_jitter(camerax() + 20, cameray() + 180, 4360);
...
prize3object = scr_marker_jitter(camerax() + 10, cameray() + 10, 4692);
...
prize6object = scr_marker_jitter(camerax() + 257, cameray() + 165, 4322);
