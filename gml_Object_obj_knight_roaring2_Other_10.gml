...
if (timer > 128)
{
    ...
    if (attack_timer == 4)
    {
        ...
        with (scr_fire_bullet(camerax() + fake_x + lengthdir_x(rand_dist, rand_angle + 180), cameray() + fake_y + lengthdir_y(rand_dist, rand_angle + 180), 31, 0, 0, 4134))
        {
            wall_destroy = false;
            destroyonhit = false;
            bottomfade = false;
...
if (intensity == 4)
{
    ...
    if (roaring_timer < 181)
    {
        ...
        if (roaring_timer > 15 && (roaring_timer % 5) == 0)
        {
            ...
            with (scr_fire_bullet(camerax() + fake_x, cameray() + fake_y + 55, 31, rand_angle, 6.5 + random(2), 4134))
            {
                visible = false;
                wall_destroy = false;
                bottomfade = false;
            ...
            with (scr_fire_bullet(camerax() + fake_x, cameray() + fake_y + 55, 31, rand_angle + 80 + random(80), 8.5 + random(2), 4134))
            {
                visible = false;
                wall_destroy = false;
                bottomfade = false;
